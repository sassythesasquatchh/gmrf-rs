...
pub use uncertainty::{
    ...
    estimate_transformed_mc_variances, exact_solve_diag, exact_solve_diag_with_progress,
    exact_solve_transformed_diag, exact_solve_transformed_diag_with_progress,
    exact_transformed_variance_weighted_trace, exact_weighted_covariance_trace,
    exact_weighted_transformed_covariance_trace, probe_batch_seed, probe_batch_sizes,
    selected_inverse_diag, selected_inverse_diag_with_diagnostics, selected_inverse_entries,
    selected_inverse_entries_with_limit, selected_inverse_transformed_diag,
    stabilize_removed_variances, stabilize_variances,
